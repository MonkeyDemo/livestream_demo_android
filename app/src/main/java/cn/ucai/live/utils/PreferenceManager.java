...
public class PreferenceManager {
	...
	private static String SHANRE_KEY_CURRENTUSER_CHANGE = "SHARED_KEY_CURRENTUSER_CHANGE";
	...
	public void setCurrentUserChange(int change){
		editor.putInt(SHANRE_KEY_CURRENTUSER_CHANGE,change);
		editor.apply();
	}
	public int getCurrentUserChange(){
		return mSharedPreferences.getInt(SHANRE_KEY_CURRENTUSER_CHANGE,0);
	}
